...
<div>
    <v-card class="dialogBox">
        ...
        <v-card-actions>
            ...
            <v-icon class="starIcon" :class="{ important: note.isImportant }" @click="addImportant">mdi-star</v-icon>
            <v-select class="ml-2 mr-2" v-model="note.selectedTags" :menu-props="{ top: true, offsetY: true }" :items="tags" attach chips label="Tags" multiple></v-select>
            <v-spacer></v-spacer>
